...
class PlanetElm {
	...
	static final PlanetElmP1 MarsE = new PlanetElmP1(
		 294.26478,		 19141.69625,		 3.15028E-4,		0.0,	// L
		 334.21833,		     1.840394,		 3.35917E-4,		0.0,	// peri
		  48.78670,		     0.776944,		-6.02778E-4,		0.0,	// node
		   1.85030,			-6.49028E-4,	 2.625E-5,			0.0,	// incl
		   0.0933088,		 0.095284E-3,	-0.122E-6,			0.0,	// e
		   1.5236781													// axis
	);
	//
	// Jupiter
	...
	private void getPlanetElm1(int planetNo, double jd) {
		double C1 = (jd - Astro.JD1900) / 36525.6366; // 36525.0;
		double C2 = C1 * C1;
		PlanetElmP1 elmCf;
		switch (planetNo) {
		case Planet.MERCURY:
	...
	private void getPlanetElm2(int planetNo, double jd) {
		double T1 = ( jd - Astro.JD2000 ) / 36525.6366; // 36525.0;
		double T2 = T1 * T1;
		double d  = T1 * 36525.6366; // 36525.0;
	...
	private void getPlanetElmEarth(double jd) {
		double c = (jd - Astro.JD1900)/36525.6366; // 36525.0;
		double c2 = c * c;
