...
public class CometOrbit {
	...
	// This is the fMaxOrbit that controls the orbit lines.
	// Similar parameter in OrbitViewer.java controls object position points.
	static private final double extraZoom = 20.0;	// fixes distant cutoffs
...
//		System.out.println("CometOrbit - Perihelion Passage at "+comet.getT()); // (awp)
